        ...
        <div className="space-y-8 pt-6">
          ...
          <div className="flex flex-col items-start text-left w-full space-y-4">
            ...
            <div className="flex items-center gap-2.5 text-teal-600 dark:text-[#2dd4bf] font-mono text-xs tracking-widest uppercase font-bold">
              <span className="w-6 h-[1.5px] bg-teal-600 dark:bg-[#2dd4bf] inline-block" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="group lg:col-span-7 bg-white/70 dark:bg-[#0b0d10]/95 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800/80 rounded-[32px] p-6 sm:p-8 flex flex-col justify-between hover:border-teal-500/30 transition-all duration-300 shadow-xl dark:shadow-2xl">
                <div className="flex items-center gap-3.5 mb-7">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-neutral-900 dark:text-white tracking-tight">AI & Automation</h3>
                    <p className="text-xs text-neutral-500 dark:text-neutral-400">Agentic Workflows & LLMs</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="flex flex-col items-center justify-center py-5 px-3 rounded-2xl bg-neutral-100/80 dark:bg-[#12141a]/80 border border-neutral-200 dark:border-neutral-800/70 hover:border-rose-500/50 hover:bg-neutral-50 dark:hover:bg-[#161922] hover:shadow-[0_0_20px_rgba(244,63,94,0.2)] hover:scale-[1.03] transition-all duration-300 cursor-pointer group">
                    ...
                    <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white">n8n</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-5 px-3 rounded-2xl bg-neutral-100/80 dark:bg-[#12141a]/80 border border-neutral-200 dark:border-neutral-800/70 hover:border-emerald-500/50 hover:bg-neutral-50 dark:hover:bg-[#161922] hover:shadow-[0_0_20px_rgba(52,211,153,0.2)] hover:scale-[1.03] transition-all duration-300 cursor-pointer group">
                    ...
                    <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white">AI Agents</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-5 px-3 rounded-2xl bg-neutral-100/80 dark:bg-[#12141a]/80 border border-neutral-200 dark:border-neutral-800/70 hover:border-yellow-500/50 hover:bg-neutral-50 dark:hover:bg-[#161922] hover:shadow-[0_0_20px_rgba(250,204,21,0.2)] hover:scale-[1.03] transition-all duration-300 cursor-pointer group">
                    ...
                    <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white">Python</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-5 px-3 rounded-2xl bg-neutral-100/80 dark:bg-[#12141a]/80 border border-neutral-200 dark:border-neutral-800/70 hover:border-teal-500/50 hover:bg-neutral-50 dark:hover:bg-[#161922] hover:shadow-[0_0_20px_rgba(45,212,191,0.2)] hover:scale-[1.03] transition-all duration-300 cursor-pointer group">
                    ...
                    <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white">OpenAI</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-5 px-3 rounded-2xl bg-neutral-100/80 dark:bg-[#12141a]/80 border border-neutral-200 dark:border-neutral-800/70 hover:border-emerald-500/50 hover:bg-neutral-50 dark:hover:bg-[#161922] hover:shadow-[0_0_20px_rgba(52,211,153,0.2)] hover:scale-[1.03] transition-all duration-300 cursor-pointer group">
                    ...
                    <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white">LangChain</span>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center py-5 px-3 rounded-2xl bg-neutral-100/80 dark:bg-[#12141a]/80 border border-neutral-200 dark:border-neutral-800/70 hover:border-neutral-400/50 hover:bg-neutral-50 dark:hover:bg-[#161922] hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:scale-[1.03] transition-all duration-300 cursor-pointer group">
                    ...
                    <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white">Flask</span>
                  </div>
              ...
              <div className="lg:col-span-5 bg-white/70 dark:bg-[#0b0d10]/95 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800/80 rounded-[32px] p-6 sm:p-8 flex flex-col justify-between hover:border-cyan-500/30 transition-all duration-300 shadow-xl dark:shadow-2xl">
                <div className="flex items-center gap-3.5 mb-6">
                  ...
                  <div>
                    <h3 className="text-base font-bold text-neutral-900 dark:text-white tracking-tight">CS Core</h3>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    { 
                      name: 'C', 
                      badge: (
                        <span className="w-7 h-7 rounded-full bg-neutral-200 dark:bg-neutral-800/90 text-neutral-800 dark:text-neutral-300 flex items-center justify-center font-bold text-xs font-mono">
                          C
                        </span>
                      ),
                      glow: 'hover:border-neutral-400/50'
                    },
                    { 
                      name: 'C++', 
                      badge: (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
              ...
              <div className="group lg:col-span-7 bg-white/70 dark:bg-[#0b0d10]/95 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800/80 rounded-[32px] p-6 sm:p-8 flex flex-col justify-between hover:border-purple-500/30 transition-all duration-300 shadow-xl dark:shadow-2xl">
                <div className="flex items-center gap-3.5 mb-6">
                  ...
                  <h3 className="text-base font-bold text-neutral-900 dark:text-white tracking-tight">Frontend Ecosystem</h3>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
                  {[
                    { name: 'JavaScript', tag: 'JS', style: 'bg-yellow-500/15 text-yellow-600 dark:text-yellow-400 border border-yellow-500/30' },
                    { name: 'TypeScript', tag: 'TS', style: 'bg-blue-500/15 text-blue-600 dark:text-blue-400 border border-blue-500/30' },
                    { name: 'React', tag: '⚛️', style: 'bg-cyan-500/15 text-cyan-600 dark:text-cyan-400 border border-cyan-500/30' },
                    { name: 'Next.js', tag: '▲', style: 'bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-white border border-neutral-300 dark:border-neutral-700' },
                    { name: 'Astro', tag: '🚀', style: 'bg-orange-500/15 text-orange-600 dark:text-orange-400 border border-orange-500/30' },
                    { name: 'Svelte', tag: '🔥', style: 'bg-red-500/15 text-red-600 dark:text-red-400 border border-red-500/30' },
                    { name: 'Redux', tag: '🟣', style: 'bg-purple-500/15 text-purple-600 dark:text-purple-400 border border-purple-500/30' },
                    { name: 'Tailwind', tag: '🌊', style: 'bg-teal-500/15 text-teal-600 dark:text-teal-400 border border-teal-500/30' },
                  ].map((item) => (
                    <div 
                      key={item.name}
                    ...
                    >
                      ...
                      <span className="text-xs font-semibold text-neutral-800 dark:text-neutral-200 truncate">{item.name}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="lg:col-span-5 bg-white/70 dark:bg-[#0b0d10]/95 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800/80 rounded-[32px] p-6 sm:p-8 flex flex-col justify-between hover:border-emerald-500/30 transition-all duration-300 shadow-xl dark:shadow-2xl">
                <div className="flex items-center gap-3.5 mb-6">
                  ...
                  <h3 className="text-base font-bold text-neutral-900 dark:text-white tracking-tight">Backend & Data</h3>
                </div>
