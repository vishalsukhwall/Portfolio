  ...
  return (
    <FlipSection>
      ...
      >
        ...
        <div
          className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full pointer-events-none blur-3xl opacity-40"
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-stretch max-w-6xl mx-auto">
              ...
              <motion.div variants={item} className="lg:col-span-6 flex flex-col justify-between space-y-6">
                <div className="p-8 rounded-2xl bg-white/85 backdrop-blur-md border border-sky-200/80 shadow-sm space-y-5">
                  <div className="flex items-center gap-2.5 text-sky-700 font-bold text-xs uppercase tracking-wider">
                    <Terminal size={16} />
                  ...
                  <div className="pt-2 flex flex-wrap items-center gap-2 text-xs font-semibold text-slate-500">
                    ...
                    <span className="text-sky-700 font-bold">Open for Full-Time Roles</span>
                  </div>
                </div>
                ...
                {education.map((edu) => (
                  <div
                    key={edu.degree}
                    className="p-6 rounded-2xl bg-white/85 backdrop-blur-md border border-sky-200/80 shadow-sm flex items-start gap-4 hover:border-sky-300 hover:shadow-md transition-all group"
                  >
                    ...
                    <div className="space-y-1 w-full min-w-0">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-bold bg-sky-100 text-sky-800 border border-sky-200 flex-shrink-0">
              ...
              <motion.div variants={item} className="lg:col-span-6 flex flex-col justify-between space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4 sm:gap-6 flex-1">
                  {stats.map((s) => (
                    <div
                      key={s.label}
                      className="p-6 rounded-2xl bg-white/85 backdrop-blur-md border border-sky-200/80 shadow-sm flex flex-col justify-between hover:border-sky-300 hover:shadow-md transition-all group"
                    >
